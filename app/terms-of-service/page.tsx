        ...
        <div className="prose prose-gray max-w-none space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li><strong>Core:</strong> 75 searches per month for $39/month or $399/year</li>
              <li><strong>Prime:</strong> 225 searches per month for $79/month or $799/year</li>
              <li><strong>Search Packs:</strong> Additional 50-search packs available for purchase</li>
            </ul>
