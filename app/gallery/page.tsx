            ...
            {items.map((item) => (
              ...
              >
                  ...
                  {item.screenshot_url ? (
                    <img
                      ...
                      onError={(e) => {
                        ...
                        if (parent) {
                          parent.innerHTML = '<div class="w-full h-32 flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200"><div class="text-gray-400 text-2xl">📱</div></div>';
                        }
                      }}
                    />
                  ) : (
                ...
                <div className="p-4 flex-1 flex flex-col">
                    ...
                    {item.app_icon_url ? (
                      <img
                        ...
                        onError={(e) => {
                          ...
                          const parent = target.parentElement;
                          if (parent) {
                            parent.innerHTML = '<div class="w-12 h-12 rounded-lg bg-gray-100 flex items-center justify-center flex-shrink-0"><span class="text-lg">📱</span></div>';
                          }
                        }}
                      />
                    ) : (
                  ...
                  {/* Description */}
                  <p className="text-sm sm:text-base text-gray-600 mb-4 flex-1 line-clamp-3 whitespace-pre-wrap">
                    {item.description}
                  </p>
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-[#88D18A] hover:bg-[#6bc070] text-white font-semibold px-4 py-2 rounded-lg transition-colors w-full text-sm"
                  >
                    Visit App
                    <svg
