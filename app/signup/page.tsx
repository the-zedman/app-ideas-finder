      ...
      <main className="flex-1 px-4 py-8 overflow-y-auto">
        <div className="max-w-md mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#3D405B]/70">Sign up to get started</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-3 px-4 bg-black hover:bg-black/90 font-medium rounded-xl flex items-center justify-center gap-3 active:scale-98 transition-all disabled:opacity-50 text-white"
            >
