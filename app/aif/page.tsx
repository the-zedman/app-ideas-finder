...
function LoginContent() {
  ...
  // Load last used login provider from localStorage (set after successful login)
  useEffect(() => {
    try {
      if (typeof window !== 'undefined') {
        const provider = window.localStorage.getItem('lastLoginProvider');
        if (provider) {
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="text-center mt-6">
            <p className="text-[#3D405B]/70">
              ...
              <Link
                href="#"
                onClick={(e) => { e.preventDefault(); alert('Sign up is no longer available'); }}
